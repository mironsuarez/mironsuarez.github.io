...
labels:
  ...
  - HTML/CSS
---
<img src="../img/framework.jpg" class="float-left-img" alt="UI framework illustration">
...
<img src="../img/grid-example.png" class="float-right-img" alt="Bootstrap grid example">
