...
### Final Project (Club Oven Lovin’)
AI played a significant role in my final project. I used it extensively for:
- Debugging issues  
- Breaking down features  
- Resolving **Prisma** and **Next.js** errors  
- Fixing **ESLint** and **Playwright** failures  
- Assisting with writing and refactoring code  
